...
function buildMessages(payload) {
  ...
  const system = [
    ...
    '- Do not suggest the next task output itself. Avoid suggestions like "write the next slide", "make the outline", "draft the next section", or "generate the summary."',
    '- try_now.title should name the collaboration move, not the deliverable.',
    '- try_now.copy should explain how that move changes the interaction pattern or keeps an important decision with the student.',
    '- Favor moves like asking for tradeoffs, asking for options without choosing, diagnosing what feels off before rewriting, or asking AI to stay at the decision level before drafting.',
